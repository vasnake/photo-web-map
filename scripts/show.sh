...
# - составить список фото-видео файлов
# - собрать атрибуты файлов: контрольная сумма, дата-время, тип (фото/видео), размер
# - убрать дубли
# - обработать фото файлы: собрать exif данные, определиться с датой-временем, коорданатами, поворотом картинки
# - обработать видео файлы: определиться с дата-время, кодек
# - составить БД для веб-карты: нормализация, геокодирование
